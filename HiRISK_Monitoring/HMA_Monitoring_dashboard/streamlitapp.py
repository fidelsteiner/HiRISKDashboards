...
df['text'] = "<br>HiRISKDB_ID: " + df["HiRISKDB_ID"].astype(str)+"<br>Name: " + df["Name"].astype(str)+"<br>Type: " + df["Type"].astype(str)+"<br>Category: " + df["Category"].astype(str)+"<br>Latitude: " + df["Latitude"].astype(str)+"<br>Longitude: " + df["Longitude"].astype(str)+"<br>min Elevation: " + df["min Elevation"].astype(str)+"<br>Elevation: " + df["Elevation"].astype(str)+"<br>max Elevation: " + df["max Elevation"].astype(str)+"<br>Country: " + df["Country"].astype(str)+"<br>Data owner/Data manager: " + df["Data owner/Data manager"].astype(str)+"<br>Manager email: " + df["Manager email"].astype(str)+"<br>Data Access Quality: " + df["Data Access Quality"].astype(str)+"<br>Data Access (URL): " + df["Data Access (URL)"].astype(str)+"<br>Data Publication: " + df["Data Publication"].astype(str)+"<br>Activity: " + df["Activity"].astype(str)+"<br>Physical Variables: " + df["Physical Variables"].astype(str)+"<br>Socioeconomic dimensions: " + df["Socioeconomic dimensions"].astype(str)+"<br>Hazard data: " + df["Hazard data"].astype(str)+"<br>Start Date: " + df["Start Date"].astype(str)+"<br>End Date: " + df["End Date"].astype(str)+"<br>Temporal frequency (highest): " + df["Temporal frequency (highest)"].astype(str)
